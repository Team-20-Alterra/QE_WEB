...
WebUI.setText(findTestObject('Auth/Register/input_Ginap_Password'), 'mgmgMgMg')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Auth/Register/p_Password unsupported'), 0)

WebUI.setText(findTestObject('Auth/Register/input_Ginap_Password'), 'mgmgmgmg177')
