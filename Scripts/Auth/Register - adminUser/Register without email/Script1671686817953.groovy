...
WebUI.setEncryptedText(findTestObject('Register/input_Ginap_Password'), 'GwweH0yE+9LB0jmG5uIxhxlv365DRkcq')

WebUI.click(findTestObject('Register/show_Hide_Password'))

WebUI.click(findTestObject('Register/button_Berikutnya'))

WebUI.verifyElementPresent(findTestObject('Register/p_This field is required'), 0)
