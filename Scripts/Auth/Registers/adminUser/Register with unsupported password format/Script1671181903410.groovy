...
WebUI.setText(findTestObject('Register/input_Ginap_Password'), 'mgmgMgMg')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Register/p_Password unsupported'), 0)

WebUI.setText(findTestObject('Register/input_Ginap_Password'), 'mgmgmgmg177')
