...
WebUI.setText(findTestObject('Object Repository/Invoice/Page_React App/input'), '2')

WebUI.verifyElementPresent(findTestObject('Object Repository/Invoice/Page_React App/invoice card'),0)
